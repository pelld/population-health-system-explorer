...
# ============================================================
# 01. BUILD PRACTICE PREVALENCE AND OVERALL POINTS ONLY
# ============================================================
    ...
    for practice_code,row in geographies.iterrows():
        ...
        practices.append({
            ...
            "overall_points":{
                ...
                "available":build.rounded(float(point_row["REVISED_MAX_POINTS"])),
...
# ============================================================
# 02. RUN THE VALIDATED BUILD AND DOCUMENT THE STATIC-FILE SCOPE
# ============================================================
def main() -> None:
    ...
    practice_data["method_notes"].append(
